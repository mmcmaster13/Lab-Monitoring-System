...
plt.title("Repump Error Monitor Voltages in Varying States (differential)")
plt.xlabel("time (s)")
plt.ylabel("signal (V)")
plt.show()
...
plt.title("Averaged Repump Error Monitor Voltages in Varying States (differential)")
plt.xlabel("time (s)")
plt.ylabel("signal (V)")
plt.show()

plt.plot(s_avg, variances)
plt.title("Variance of Repump Error Monitor Voltages in Varying States (differential)")
plt.xlabel("time (s)")
